...
public enum MicroBlazeInstructionSetFields implements InstructionSetFields {
    ...
    // Multiplication
    mul(0b010000, 1, InstructionType.mul),
    mulh(0b010000, 1, InstructionType.mul),
    mulhu(0b010000, 1, InstructionType.mul),
    mulhsu(0b010000, 1, InstructionType.mul),
    muli(0b011000, 1, InstructionType.mul),
    ...
    // Floating Point
    fadd(0b010110, 1, InstructionType.floatingpoint),
    frsub(0b010110, 1, InstructionType.floatingpoint),
    fmul(0b010110, 1, InstructionType.floatingpoint),
    fdiv(0b010110, 1, InstructionType.floatingpoint),
    fcmp_un(0b010110, 1, InstructionType.floatingpoint),
    fcmp_lt(0b010110, 1, InstructionType.floatingpoint),
    fcmp_eq(0b010110, 1, InstructionType.floatingpoint),
    fcmp_le(0b010110, 1, InstructionType.floatingpoint),
    fcmp_gt(0b010110, 1, InstructionType.floatingpoint),
    fcmp_ne(0b010110, 1, InstructionType.floatingpoint),
    fcmp_ge(0b010110, 1, InstructionType.floatingpoint),
    flt(0b010110, 1, InstructionType.floatingpoint),
    fint(0b010110, 1, InstructionType.floatingpoint),
    fsqrt(0b010110, 1, InstructionType.floatingpoint),

    // Store
    sb(0b110100, 1, InstructionType.store),
    sbr(0b110100, 1, InstructionType.store),
    sbi(0b111100, 1, InstructionType.store),
    sh(0b110101, 1, InstructionType.store),
    shr(0b110101, 1, InstructionType.store),
    shi(0b111101, 1, InstructionType.store),
    sw(0b110110, 1, InstructionType.store),
    swr(0b110110, 1, InstructionType.store),
    swi(0b111110, 1, InstructionType.store),
    swx(0b110110, 1, InstructionType.store),

    // Load
    lbu(0b110000, 1, InstructionType.load),
    lbur(0b110000, 1, InstructionType.load),
    lbui(0b111000, 1, InstructionType.load),
    lhu(0b110001, 1, InstructionType.load),
    lhur(0b110001, 1, InstructionType.load),
    lhui(0b111001, 1, InstructionType.load),
    lw(0b110010, 1, InstructionType.load),
    lwr(0b110010, 1, InstructionType.load),
    lwi(0b111010, 1, InstructionType.load),
    lwx(0b110010, 1, InstructionType.load),

    // Others
    idiv(0b010010, 1, InstructionType.other),
    idivu(0b010010, 1, InstructionType.other),
    ...
    put(0b011011, 1, InstructionType.other),
    putd(0b010011, 1, InstructionType.other),
