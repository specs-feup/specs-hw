...
/**
 * MbInstruction extended with additional information. Adds carry operands to list of operands.
 *
 * @author Joao Bispo
 */
public class MbInstructionExtParser {
    ...
    private void addInstruction(List<MbInstruction> mbInstructions, int i) {
        ...
        */
        extendedInsts.add(new MbInstructionExt(mbInstruction, branchTaken, isExit, hasCarryIn, hasCarryOut,
                nextAtomicAddress, noJumpAddress));
    }
