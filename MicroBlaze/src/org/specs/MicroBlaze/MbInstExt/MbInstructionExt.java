...
public class MbInstructionExt {
   ...
   public MbInstructionExt(MbInstruction inst, Boolean branchTaken, boolean isExit, boolean hasCarryIn, boolean hasCarryOut, int targetAddress, int noJumpAddress) {
      this.inst = inst;
...
*/
    ...
    * <p>Has into account the expected jumps during the execution.
    *
    */
