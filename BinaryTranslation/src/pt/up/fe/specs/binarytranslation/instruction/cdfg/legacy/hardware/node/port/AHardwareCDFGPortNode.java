...
package pt.up.fe.specs.binarytranslation.instruction.cdfg.legacy.hardware.node.port;

import pt.up.fe.specs.binarytranslation.instruction.cdfg.legacy.generic.node.data.AGenericCDFGDataNode;
import pt.up.fe.specs.binarytranslation.instruction.cdfg.legacy.hardware.signal.HardwareCDFGGenericSignal;
import pt.up.fe.specs.binarytranslation.instruction.cdfg.legacy.hardware.signal.IHardwareCDFGGenericSignal;
