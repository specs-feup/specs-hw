...
package pt.up.fe.specs.binarytranslation.instruction.calculator.generator.operation.unary.logical;

import pt.up.fe.specs.binarytranslation.instruction.calculator.generator.PseudoInstructionCalculatorRegister;

public class PseudoInstructionCalculatorLogicalNot extends APseudoInstructionCalculatorUnaryLogicalOperation{

    @Override
    public Number apply(PseudoInstructionCalculatorRegister operand) throws IllegalArgumentException{
