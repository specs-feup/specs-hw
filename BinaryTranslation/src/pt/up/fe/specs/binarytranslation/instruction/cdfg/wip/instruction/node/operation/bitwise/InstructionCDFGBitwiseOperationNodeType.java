...
package pt.up.fe.specs.binarytranslation.instruction.cdfg.wip.instruction.node.operation.bitwise;
...
public enum InstructionCDFGBitwiseOperationNodeType implements InstructionCDFGOperationNode{

    BitwiseOr("|", "bor", InstructionCDFGBitwiseOrNode.class),
    BitwiseXor("^", "bxor", InstructionCDFGBitwiseXorNode.class),
    BitwiseAnd("&", "band", InstructionCDFGBitwiseAndNode.class),
    BitwiseNot("~", "bnot", InstructionCDFGBitwiseNotNode.class)
    ...
    private InstructionCDFGBitwiseOperationNodeType(String operator, String operator_name, Class<? extends AInstructionCDFGOperationNode> operation_class) {
