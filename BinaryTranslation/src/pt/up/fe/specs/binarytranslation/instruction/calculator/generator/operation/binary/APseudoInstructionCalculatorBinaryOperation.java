...
public abstract class APseudoInstructionCalculatorBinaryOperation extends APseudoInstructionCalculatorOperation implements BiFunction<PseudoInstructionCalculatorRegister, PseudoInstructionCalculatorRegister, Number>{

    protected boolean integerOperands(PseudoInstructionCalculatorRegister operandLeft, PseudoInstructionCalculatorRegister operandRight) {
        return ((operandLeft.getValue() instanceof Integer) && (operandRight.getValue() instanceof Integer));
    }
    
    protected boolean floatOperands(PseudoInstructionCalculatorRegister operandLeft, PseudoInstructionCalculatorRegister operandRight) {
