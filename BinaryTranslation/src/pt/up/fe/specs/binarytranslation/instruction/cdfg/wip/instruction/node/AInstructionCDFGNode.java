...
package pt.up.fe.specs.binarytranslation.instruction.cdfg.wip.instruction.node;
...
public abstract class AInstructionCDFGNode{
    ...
    public boolean equals(Object obj) {
        ...
        if(obj instanceof AInstructionCDFGNode) {
            ...
            AInstructionCDFGNode obj_n = (AInstructionCDFGNode) obj;
            
            if(obj_n.getReference().equals(this.getReference())) {
                return true;
            }
