...
public abstract class InstructionDFGOperationNode extends InstructionDFGNode{

    private Number address;
    
    protected InstructionDFGOperationNode(InstructionDFGOperationNodeType type, Object operation) {
        super(InstructionDFGNodeType.OperationNode);
