...
package pt.up.fe.specs.binarytranslation.instruction.cdfg.instruction.node.operation;
...
import pt.up.fe.specs.binarytranslation.instruction.cdfg.instruction.node.operation.arithmetic.InstructionCDFGArithmeticOperationNodeType;
import pt.up.fe.specs.binarytranslation.instruction.cdfg.instruction.node.operation.bitwise.InstructionCDFGBitwiseOperationNodeType;
import pt.up.fe.specs.binarytranslation.instruction.cdfg.instruction.node.operation.comparison.InstructionCDFGComparisonOperationNodeType;
import pt.up.fe.specs.binarytranslation.instruction.cdfg.instruction.node.operation.logical.InstructionCDFGLogicalOperationNodeType;
...
public class InstructionCDFGOperationNodeMap {
    ...
    static {
        ...
        map.put(InstructionCDFGArithmeticOperationNodeType.Assignment.getOperator(), InstructionCDFGArithmeticOperationNodeType.Assignment.getConstructor());
