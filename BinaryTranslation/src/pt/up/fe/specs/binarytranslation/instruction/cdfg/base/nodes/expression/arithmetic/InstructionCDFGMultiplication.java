...
public class InstructionCDFGMultiplication extends AInstructionCDFGArithmeticNode{

    public InstructionCDFGMultiplication() {
        super("*");
    }
    
    public AInstructionCDFGNode apply() {
        return new InstructionCDFGMultiplication();
    }
}
