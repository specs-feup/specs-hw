...
public class InstructionDFGInstructionGenerator extends PseudoInstructionBaseVisitor<InstructionDFGNode>{

    // It's only necessary to "look into" when the operators and operands of the tree are visited and if nodes and other similar
    // The more top level nodes can be ignored
    //
    
    public InstructionDFGInstruction generate(Instruction instruction) {
...
*/
    ...
    /*
    @Override
    public InstructionDFGNode visitAssignmentExpr(AssignmentExprContext ctx) {
        return new AssignmentExpressionASTNode((OperandASTNode) this.visit(ctx.left),
                (ExpressionASTNode) this.visit(ctx.right));
    }
*/
  /*  @Override
    public InstructionDFGNode visitBinaryExpr(BinaryExprContext ctx) {
...
*/
    @Override
    public InstructionDFGNode visitUnaryExpr(UnaryExprContext ctx) {
    ...
    // Operator level /////////////////////////////////////////////////////////
    @Override
    public InstructionDFGMathOperationNode visitOperator(OperatorContext ctx) {
        return new InstructionDFGMathOperationNode(ctx.getText());
    }
