...
package pt.up.fe.specs.binarytranslation.instruction.cdfg.wip.instruction.node.operation.arithmetic;
...
public enum InstructionCDFGArithmeticOperationNodeType implements InstructionCDFGOperationNode{

    Addition("+", "add", InstructionCDFGAdditionNode.class),
    Subtraction("-", "sub", InstructionCDFGSubtractionNode.class),
    ...
    private InstructionCDFGArithmeticOperationNodeType(String operator, String operator_name, Class<? extends AInstructionCDFGOperationNode> operation_class) {
