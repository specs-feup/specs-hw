...
public class CppCompoundStatement extends CppStatement{

    public CppCompoundStatement() {
        
    }
    
    private CppCompoundStatement(List<CppNode> children) {
    ...
    protected CppNode copyPrivate() {
        return new CppCompoundStatement(this.getChildren());
    }
