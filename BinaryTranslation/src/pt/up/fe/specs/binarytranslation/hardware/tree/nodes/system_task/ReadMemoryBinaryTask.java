...
public class ReadMemoryBinaryTask extends AReadMemoryTask{
    ...
    protected HardwareNode copyPrivate() {
        ...
        if(this.hasBoundaries()) {
            return new ReadMemoryBinaryTask(this.getFileName(), this.getArray(), this.getStartAddress(), this.getEndAddress());
        }else {
            return new ReadMemoryBinaryTask(this.getFileName(), this.getArray());
        }
