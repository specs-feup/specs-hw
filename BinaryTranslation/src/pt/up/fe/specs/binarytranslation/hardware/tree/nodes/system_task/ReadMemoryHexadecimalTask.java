...
public class ReadMemoryHexadecimalTask extends AReadMemoryTask{
    ...
    protected HardwareNode copyPrivate() {
        ...
        if(this.hasBoundaries()) {
            return new ReadMemoryHexadecimalTask(this.getFileName(), this.getArray(), this.getStartAddress(), this.getEndAddress());
        }else {
            return new ReadMemoryHexadecimalTask(this.getFileName(), this.getArray());
        }
