 ...
 *
 */
public class FrequentStaticSequenceDetector extends AFixedSizeFrequentSequenceDetector {
    ...
    public FrequentStaticSequenceDetector(DetectorConfiguration config) {
        super(config);
    }
