...
public class GreaterThanExpression extends ABinaryHardwareExpression {

    public GreaterThanExpression(HardwareExpression varA, HardwareExpression varB) {
    ...
    @Override
    public GreaterThanExpression getThis() {
        return this;
    }
    ...
    @Override
    public GreaterThanExpression copy() {
        return (GreaterThanExpression) super.copy();
    }
}
