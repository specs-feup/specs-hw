...
public class BitWiseXorExpression extends ABinaryHardwareExpression {

    public BitWiseXorExpression(HardwareExpression varA, HardwareExpression varB) {
    ...
    @Override
    public BitWiseXorExpression getThis() {
        return this;
    }
    ...
    @Override
    public BitWiseXorExpression copy() {
        return (BitWiseXorExpression) super.copy();
    }
}
