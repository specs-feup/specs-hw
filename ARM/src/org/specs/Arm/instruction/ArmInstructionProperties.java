...
public enum ArmInstructionProperties implements InstructionProperties {
    ...
    sturb(0x3800_0000, 1, 0, LOAD_STORE_PAIR_IMM_FMT1, G_MEMORY, G_STORE),
    ldurb(0x3840_0000, 1, 0, LOAD_STORE_PAIR_IMM_FMT1, G_MEMORY, G_LOAD),
    sturh(0x7800_0000, 1, 0, LOAD_STORE_PAIR_IMM_FMT1, G_MEMORY, G_STORE),
    ldurh(0x7840_0000, 1, 0, LOAD_STORE_PAIR_IMM_FMT1, G_MEMORY, G_LOAD),
    ldursw(0xB880_0000, 1, 0, LOAD_STORE_PAIR_IMM_FMT1, G_MEMORY, G_LOAD),
    prfum(0xF880_0000, 1, 0, LOAD_STORE_PAIR_IMM_FMT1, G_MEMORY, G_LOAD),

    // LOAD_STORE_PAIR_IMM_UNSCALED_FMT2 (C4-283 to C4-284)
    ldursb32("ldursb", 0x38C0_0000, 1, 0, LOAD_STORE_PAIR_IMM_FMT2, G_MEMORY, G_LOAD),
    ldursb64("ldursb", 0x3880_0000, 1, 0, LOAD_STORE_PAIR_IMM_FMT2, G_MEMORY, G_LOAD),
    ldursh32("ldursh", 0x78C0_0000, 1, 0, LOAD_STORE_PAIR_IMM_FMT2, G_MEMORY, G_LOAD),
    ldursh64("ldursh", 0x7880_0000, 1, 0, LOAD_STORE_PAIR_IMM_FMT2, G_MEMORY, G_LOAD),
    stur32("stur", 0xB800_0000, 1, 0, LOAD_STORE_PAIR_IMM_FMT2, G_MEMORY, G_STORE),
    stur64("stur", 0xF800_0000, 1, 0, LOAD_STORE_PAIR_IMM_FMT2, G_MEMORY, G_STORE),
    ldur32("ldur", 0xB840_0000, 1, 0, LOAD_STORE_PAIR_IMM_FMT2, G_MEMORY, G_LOAD),
    ldur64("ldur", 0xF840_0000, 1, 0, LOAD_STORE_PAIR_IMM_FMT2, G_MEMORY, G_LOAD),

    // LOAD_STORE_PAIR_IMM_UNSCALED_FMT3 (C4-283 to C4-284)
    stur_simd("stur", 0x3C00_0000, 1, 0, LOAD_STORE_PAIR_IMM_FMT3, G_MEMORY, G_STORE),
    ldur_simd("ldur", 0x3C40_0000, 1, 0, LOAD_STORE_PAIR_IMM_FMT3, G_MEMORY, G_LOAD),

    ///////////////////////////////////////////////////////////////////////////

    // LOAD_STORE_PAIR_UNPRIV_FMT1 (C4-286)
    sttrb(0x3800_0800, 1, 0, LOAD_STORE_PAIR_IMM_FMT1, G_MEMORY, G_STORE),
    ldtrb(0x3840_0800, 1, 0, LOAD_STORE_PAIR_IMM_FMT1, G_MEMORY, G_LOAD),
    sttrh(0x7800_0800, 1, 0, LOAD_STORE_PAIR_IMM_FMT1, G_MEMORY, G_STORE),
    ldtrh(0x7840_0800, 1, 0, LOAD_STORE_PAIR_IMM_FMT1, G_MEMORY, G_LOAD),
    ldtrsw(0xB880_0800, 1, 0, LOAD_STORE_PAIR_IMM_FMT1, G_MEMORY, G_LOAD),

    // LOAD_STORE_PAIR_UNPRIV_FMT2 (C4-286)
    ldtrsb32("ldtrsb", 0x38C0_0800, 1, 0, LOAD_STORE_PAIR_IMM_FMT2, G_MEMORY, G_LOAD),
    ldtrsb64("ldtrsb", 0x3880_0800, 1, 0, LOAD_STORE_PAIR_IMM_FMT2, G_MEMORY, G_LOAD),
    ldtrsh32("ldtrsh", 0x78C0_0800, 1, 0, LOAD_STORE_PAIR_IMM_FMT2, G_MEMORY, G_LOAD),
    ldtrsh64("ldtrsh", 0x7880_0800, 1, 0, LOAD_STORE_PAIR_IMM_FMT2, G_MEMORY, G_LOAD),
    sttr32("sttr", 0xB800_0800, 1, 0, LOAD_STORE_PAIR_IMM_FMT2, G_MEMORY, G_STORE),
    sttr64("sttr", 0xF800_0800, 1, 0, LOAD_STORE_PAIR_IMM_FMT2, G_MEMORY, G_STORE),
    ldtr32("ldtr", 0xB840_0800, 1, 0, LOAD_STORE_PAIR_IMM_FMT2, G_MEMORY, G_LOAD),
    ldtr64("ldtr", 0xF840_0800, 1, 0, LOAD_STORE_PAIR_IMM_FMT2, G_MEMORY, G_LOAD),

    ///////////////////////////////////////////////////////////////////////////

    // LOAD_STORE_PAIR_IMM_PREPOST_FMT1 (C4-284 to C4-285 and C4-286 to C4-287)
    strb(0x3800_0400, 1, 0, LOAD_STORE_IMM_PREPOST_FMT1, G_MEMORY, G_STORE),
    ldrb(0x3840_0400, 1, 0, LOAD_STORE_IMM_PREPOST_FMT1, G_MEMORY, G_LOAD),
    strh(0x7800_0400, 1, 0, LOAD_STORE_IMM_PREPOST_FMT1, G_MEMORY, G_STORE),
    ldrh(0x7840_0400, 1, 0, LOAD_STORE_IMM_PREPOST_FMT1, G_MEMORY, G_LOAD),
    ldrsw(0xB880_0400, 1, 0, LOAD_STORE_IMM_PREPOST_FMT1, G_MEMORY, G_LOAD),

    // LOAD_STORE_PAIR_IMM_PREPOST_FMT2 (C4-284 to C4-285 and C4-286 to C4-287)
    ldrsb32("ldrsb", 0x38C0_0400, 1, 0, LOAD_STORE_IMM_PREPOST_FMT2, G_MEMORY, G_LOAD),
    ldrsb64("ldrsb", 0x3880_0400, 1, 0, LOAD_STORE_IMM_PREPOST_FMT2, G_MEMORY, G_LOAD),
    ldrsh32("ldrsh", 0x78C0_0400, 1, 0, LOAD_STORE_IMM_PREPOST_FMT2, G_MEMORY, G_LOAD),
    ldrsh64("ldrsh", 0x7880_0400, 1, 0, LOAD_STORE_IMM_PREPOST_FMT2, G_MEMORY, G_LOAD),
    str32("str", 0xB800_0400, 1, 0, LOAD_STORE_IMM_PREPOST_FMT2, G_MEMORY, G_STORE),
    str64("str", 0xF800_0400, 1, 0, LOAD_STORE_IMM_PREPOST_FMT2, G_MEMORY, G_STORE),
    ldr32("ldr", 0xB840_0400, 1, 0, LOAD_STORE_IMM_PREPOST_FMT2, G_MEMORY, G_LOAD),
    ldr64("ldr", 0xF840_0400, 1, 0, LOAD_STORE_IMM_PREPOST_FMT2, G_MEMORY, G_LOAD),

    // LOAD_STORE_PAIR_IMM_PREPOST_FMT3 (C4-284 to C4-285 and C4-286 to C4-287)
    str_simd("str", 0x3C00_0400, 1, 0, LOAD_STORE_IMM_PREPOST_FMT3, G_MEMORY, G_STORE),
    ldr_simd("ldr", 0x3C40_0400, 1, 0, LOAD_STORE_IMM_PREPOST_FMT3, G_MEMORY, G_LOAD),
